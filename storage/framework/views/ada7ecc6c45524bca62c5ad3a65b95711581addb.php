...
<div class="h-screen bg-gray-100 flex justify-center items-center">
    <div class="w-full max-w-full lg:max-w-6xl mx-auto bg-white rounded-lg shadow-md overflow-hidden">
      <div class="md:flex">
        ...
        <div class="p-8">
          ...
          <div class="mt-4 flex justify-center">
            ...
            <a href="<?php echo e(route('login')); ?>" class="inline-block bg-indigo-600 hover:bg-indigo-700 text-white py-2 px-4 rounded">Login</a>
            <a href="<?php echo e(route('register')); ?>" class="inline-block bg-gray-400 hover:bg-gray-500 text-white py-2 px-4 rounded ml-2">Register</a>
            <?php endif; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\lmns\lime\resources\views/index.blade.php ENDPATH**/ ?>