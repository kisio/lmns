...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.nav-link','data' => ['href' => route('search'),'active' => request()->routeIs('search')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                <div class="hidden sm:flex sm:items-center sm:ml-6">
                    ...
                    <div class="hidden sm:flex sm:items-center sm:ml-6">
                        ...
                        <li>
                            <a href="<?php echo e(route('login')); ?>" class="block px-4 py-2 text-sm text-white hover:bg-gray-100">
                                <?php echo e(__('Login')); ?>

                            </a>
                        </li> <li>
                            <a href="<?php echo e(route('register')); ?>" class="block px-4 py-2 text-sm text-white hover:bg-gray-100">
...
<?php /**PATH C:\xampp\htdocs\lmns\lime\resources\views/layouts/navigation.blade.php ENDPATH**/ ?>